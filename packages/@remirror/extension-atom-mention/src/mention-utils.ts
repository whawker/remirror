...
import type { MentionAtomExtensionAttributes, MentionAtomExtensionMatcher } from './mention-types';
...
export function isValidMentionAttributes(
  attributes: unknown,
): attributes is MentionAtomExtensionAttributes {
 ...
 */
export function getMatcher(name: string, matchers: MentionAtomExtensionMatcher[]) {
