 ...
 */
export type MentionAtomExtensionAttributes = ProsemirrorAttributes<
...
export interface MentionAtomOptions {
   ...
   * @defaultValue `() => false`
   */
  onCharacterEntry?: Handler<MentionCharacterEntryMethod>;
...
export type SuggestionCommandAttributes = ProsemirrorAttributes<
  Partial<
    Pick<MentionAtomExtensionAttributes, 'id' | 'label' | 'appendText' | 'replacementType'>
  > & {
    /**
 ...
 */
export type MentionAtomExtensionSuggestCommand = (attrs: SuggestionCommandAttributes) => void;
export type MentionKeyBinding = SuggestKeyBindingMap<MentionAtomExtensionSuggestCommand>;
export type MentionKeyBindingParameter = SuggestKeyBindingParameter<
  MentionAtomExtensionSuggestCommand
>;
export type MentionChangeHandlerMethod = SuggestChangeHandlerMethod<
  MentionAtomExtensionSuggestCommand
>;
export type MentionChangeHandlerParameter = SuggestChangeHandlerParameter<
  MentionAtomExtensionSuggestCommand
>;
export type MentionExitHandlerMethod = SuggestExitHandlerMethod<MentionAtomExtensionSuggestCommand>;
